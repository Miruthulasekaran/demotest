...
export default function OrganizationProfileEdit(props) {
    ...
    useEffect(() => {
        ...
        setId(idds)
        ApiService.OrganizationProfileEditGet(params.id).then((resp)=>{
    ...
    let OnCreateObj = (e) => {
        ...
        if (profile.trim() == "" && parameter.trim() == "" && drpDwn == "") {
            ...
            setid(id => id + 1);
            let createObj = { parameter: parameter, dataType: drpDwn }
    ...
    useEffect(() => {
        if (profile == "") {
            ...
            setFinalArr({ created_by: "test", custom_data: Arr, organization_profile_name: profile, updated_by: "TestUpdate" })
    ...
    let backendData = () => {
        if (profile.trim() == "" ) {
            ...
            ApiService.OrganizationProfilePatch(params.id , finalArr).then((resp)=>{
                if(resp.message){
                                            ...
                                            <Col lg="5">
                                                <FormGroup>
                                                    ...
                                                    <Input type="select" className='text-dark' onChange={OnDataType} value={drpDwn} name="select" id="exampleSelect">
                                                        <option value="" selected disabled>Select data yype</option>
                                                ...
                                                Arr.map((item, index1) => {
                                                    return <div key={index1} class="row ml-3">
                                                        ...
                                                        <div class="col-md-3 mb-4">
                                                            <div class="">
                                                                <label for="exampleDatepicker1" class="form-label text-dark">{item.dataType}</label>
                                                            </div>
                                                        </div>
