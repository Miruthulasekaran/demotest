...
export default function OrganizationProfileAdd() {
    ...
    let OnCreateObj = (e) => {
        ...
        if (profile.trim() == "" && parameter.trim() == "" && drpDwn == "") {
            ...
            setid(id => id + 1);
            let createObj = { parameter: parameter, dataType: drpDwn, profile: profile }
    ...
    useEffect(() => {
        setFinalArr({ created_by: "test", custom_data: Paramvalue, organization_profile_name: profile, updated_by: "TestUpdate" })
    ...
    let backendData = () => {
        if (profile.trim() == "") {
            ...
            ApiService.OrganizationProfilePost(finalArr).then((resp) => {
                if (resp.message) {
                    ...
                    // alert("organization profile name already exists !")
                }
                else {
    ...
    let OnEdit = (e) => {
        ...
        setDrpDwn(editValue.dataType)
        // console.log("this is edit item", Paramvalue);
        ...
        if (profile.trim() == "") {
            ...
            setParamValue(Paramvalue.map((element) => {
                if (element.parameter === TempId) {
                    return { ...element, parameter: parameter, dataType: drpDwn, profile: profile }
                }
                return element;
            }))
                                        ...
                                        <Row>
                                            ...
                                            <Col lg="5">
                                                <FormGroup>
                                                    ...
                                                    <Input type="select" className='text-dark' onChange={OnDataType} value={drpDwn} name="select" id="drpdown">
                                                ...
                                                Paramvalue.map((item, index1) => {
                                                    return <div key={index1} class="row ml-3">
                                                        ...
                                                        <div class="col-md-4 mb-4">
                                                            <div class="">
                                                                <td for="exampleDatepicker1" class="form-label text-dark">{item.parameter}</td>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 mb-4">
                                                            <div class="">
                                                                <td for="exampleDatepicker1" class="form-label text-dark">{item.dataType}</td>
                                                            </div>
                                                        </div>
